  ...
  sid.innerHTML = `
    ...
    <div class="sb-search-wrap">
      <div class="sb-search">
        ...
        <input class="sb-search-input" placeholder="Cari..." data-i18n="sb.search" oninput="sidebarSearch(this.value)" />
      </div>
    </div>

    <!-- Main Nav -->
    <div class="sb-section">
      <div class="sb-section-label" data-i18n="sb.menu">Menu Utama</div>
      <a href="dashboard.html" class="sb-link ${activePage === 'dashboard' ? 'active' : ''}" title="Dashboard">
        ...
        <span class="sb-link-text" data-i18n="sb.dash">Dashboard</span>
      </a>
      <a href="projects.html" class="sb-link ${activePage === 'projects' ? 'active' : ''}" title="Semua Proyek">
        ...
        <span class="sb-link-text" data-i18n="sb.proj">Semua Proyek</span>
      </a>
      <a href="laporan.html" class="sb-link ${activePage === 'laporan' ? 'active' : ''}" title="Laporan">
        ...
        <span class="sb-link-text" data-i18n="sb.rep">Laporan</span>
      </a>
    </div>
    ...
    <div class="sb-section sb-projects-section" style="flex:1;overflow:hidden;display:flex;flex-direction:column;">
      <div class="sb-section-label" style="display:flex;align-items:center;justify-content:space-between;">
        <span data-i18n="sb.myproj">Proyek Saya</span>
        <button class="sb-add-btn" onclick="document.getElementById('new-project-modal')&&(document.getElementById('new-project-modal').style.display='flex')" title="Proyek Baru" data-i18n="sb.new">+</button>
      </div>
    ...
    <div class="sb-footer">
      <a href="profile.html" class="sb-user" title="Profil Saya" style="text-decoration:none;">
        ...
        <div class="sb-user-info">
          ...
          <div class="sb-user-role" data-i18n="sb.profile">Lihat Profil</div>
        </div>
      </a>
    </div>
  `;
